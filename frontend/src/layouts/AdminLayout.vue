  ...
  <div class="admin-container">
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <router-link to="/admin/emploi" class="nav-item" active-class="active">
          <span class="nav-icon">📅</span>
          <span class="nav-text">Emploi du temps</span>
        </router-link>
        <!--
        <router-link to="/admin/filieres" class="nav-item" active-class="active">
          <span class="nav-icon">📚</span>
          <span class="nav-text">Filières & Modules</span>
        </router-link>
        
        <router-link to="/admin/groupes" class="nav-item" active-class="active">
          <span class="nav-icon">👥</span>
          <span class="nav-text">Groupes</span>
        </router-link>
      -->
        <router-link to="/chef/validation" class="nav-item" active-class="active">
          <span class="nav-icon">✅</span>
        ...
        <router-link to="/admin/parametres" class="nav-item" active-class="active">
  ...
  methods: {
    ...
    updatePageName() {
      ...
      const pageNames = {
        ...
        '/admin/emploi': 'Emploi du temps',
        '/chef/validation': 'Validation Chef',
        '/admin/filieres': 'Filières & Modules',
        '/admin/groupes': 'Groupes',
        '/admin/parametres': 'Paramètres'
      };
      this.currentPageName = pageNames[route] || 'Tableau de bord';
    }
  }
}
</script>
